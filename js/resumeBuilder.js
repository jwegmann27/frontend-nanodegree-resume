//Objects
//for future projects remmeber use a var for %data% becuase it is refrenced so often.
var bio = {
    "name": "Joseph Wegmann",
    ...
    "contacts": {
        ...
        "mobile": "(516) 650-2778",
        "github": "jwegmann27",
        "twitter": "https://www.linkedin.com/in/joseph-wegmann-8001aab2",
...
bio.display = function() {
        ...
        var formattedLinked = HTMLtwitter.replace("%data%", bio.contacts.twitter);
...
work.display = function() {
        //next time use a foreach loop instead of for in because for in is error prone. 
        for (var job in work.jobs) { //cycles all jobs in the work object 
...
education.display = function() {
    ...
    for (var onlinecourse in education.onlineCourse) {
